            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="about-image">
                        <img src="..\image\petlogo.jpg" alt="Team" class="img-fluid rounded-circle">
                    </div>
                </div>

                <!-- About Us Text -->
                <div class="col-md-6">
                <h2 class="section-title text-center text-primary" style="color: yellow";>About Us</h2>


                    <p class="lead text-center">
                        At <strong>Pet Bondhu</strong>, we are dedicated to creating a safe, loving space for pets and pet owners alike. 
                        Our goal is to connect pet lovers with the resources they need for adoption, shopping, and healthcare.
                    </p>
                    <div class="mission">
                        <h4><i class="fas fa-paw"></i> Our Mission</h4>
                        <p style="color:yellow";>We aim to promote responsible pet ownership, ensuring every pet finds a safe, caring home. We provide a platform 
